...
public class ScanItemsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultSearchView = findViewById(R.id.search_field);
        scanToSearch = findViewById(R.id.camera_button);
        searchButton = findViewById(R.id.search_item_button);

        myRecyclerView = findViewById(R.id.recycler_views);
    ...
    public static class UsersViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setDetails(Context ctx, String itemBarcode, String itemCategory, String itemName, String itemPrice) {
            TextView item_barcode = (TextView) mView.findViewById(R.id.view_item_barcode);
            TextView item_name = (TextView) mView.findViewById(R.id.view_item_name);
            TextView item_category = (TextView) mView.findViewById(R.id.view_item_category);
            TextView item_price = (TextView) mView.findViewById(R.id.view_item_price);
